			...
			<div  class="card-1" style="overflow:scroll; background-color:white; ">
				<table id="" class="ex1" cellspacing="0" width="100%">
					<tr>
							...
							<!--<td style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a style="color: blue;" href="https://supplier-portal.herokuapp.com/packinglistreadytoship.html">Refresh</a></td>-->
					</tr>
				</table>
				<table id="" class="display ex1" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							<td><a style="color: blue;" href="https://supplier-portal.herokuapp.com/packinglistview?pl_number=<%= pl_list[i].packing_list_num%>"><%= pl_list[i].packing_list_num%></a></td>
